...
seq1H_genlog: seqeunce learning model 2stack conv enc (256)
- q(x), l(x)
...
parser.add_argument("-s","--save_path",type=str, default="./save/exp_seq1H_genlog256/")
...
class SeqModel(nn.Module):
    def __init__(self, input_dim=INPUT_DIM, e_ch=128, d_ch=256, use_glu=USE_GLU):
