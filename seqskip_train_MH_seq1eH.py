...
parser.add_argument("-s","--save_path",type=str, default="./save/exp_MH_seq1eH_v1/")
...
class SeqModel(nn.Module):
    def __init__(self, input_dim=INPUT_DIM, e_ch=128, d_ch=128, use_glu=USE_GLU):
        ...
        self.enc = SeqEncoder(input_ch=e_ch, e_ch=e_ch,
    ...
    def forward(self, x_sup, x_que):
        ...
        feat_que = self.feature_que(x_que)
