...
parser.add_argument("-s","--save_path",type=str, default="./save/exp_seq1G/")
...
parser.add_argument("-glu","--use_glu", type=bool, default=True)
...
def main():  
    ...
    SM = SeqModel(input_dim=_input_dim, e_ch=128, d_ch=128, use_glu=USE_GLU).cuda(GPU)
