...
class SeqModel(nn.Module):
    def __init__(self, input_dim=64, e_ch=128, d_ch=128, use_glu=False):
...
class RelationNetwork(nn.Module):
    ...
    def __init__(self, 
        ...
        self.layer1 = nn.Sequential(
                        nn.Linear(self.layer1_input_sz, 128), # bx8x7x1*128 -> bx8x7x1*512
                        nn.LayerNorm(128),
                        nn.ReLU())
    ...
    def forward(self, x_sup, x_que, x_log_sup, y_log_que, label_sup):
        ...
        out = out.permute(0,4,1,2,3)   # bx64 x 7x8x1
