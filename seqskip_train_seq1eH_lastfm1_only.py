...
parser.add_argument("-s","--save_path",type=str, default="./save/exp_seq1eH_lastfm1_only/")
...
LFM_CHECKPOINT_PATH = "./LastFM/exp_lastfm_mlp_reg2/check_1800.pth"
...
def validate(mval_loader, SM, LFM_model, eval_mode):
    ...
    for val_session in trange(len(val_sessions_iter), desc='val-sessions', position=2, ascii=True):
        ...
        del x_emb_lastfm
        # x: bx122*20
        x[:,:,41:] = 0 # remove original audio features
