...
parser.add_argument("-m","--model_py", type = str, default="./seqskip_train_seq1eH.py")
parser.add_argument("-s","--save_path",type = str, default="./save/exp_seq1eH/check_4_48811.pth") # directory of saved checkpoint
