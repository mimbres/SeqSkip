...
parser = argparse.ArgumentParser(description="Sequence Skip Prediction with CF")
parser.add_argument("-c","--config",type=str, default="./config_init_dataset.json")
parser.add_argument("-s","--save_path",type=str, default="./save/exp_seq1eH_CF50mse/")
...
CF_CHECKPOINT_PATH = "./CF/exp_cf_fm_50_mlp_reg1/check_100.pth"
...
class MLP_Regressor(nn.Module):
    def __init__(self, input_d=29, output_d=50,
                 emb_d=48, mid_d=256): # emb_dim means the l-1 layer's dimension
...
def main():  
    ...
    CF_checkpoint = torch.load(CF_CHECKPOINT_PATH, map_location='cuda:{}'.format(GPU))
