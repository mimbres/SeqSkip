...
parser.add_argument("-s","--save_path",type=str, default="./save/exp_seq2eH_noncausal_norm/")
...
class SeqModel(nn.Module):
    ...
    def forward(self, x_sup, x_que):
        ...
        att = F.softmax(torch.matmul(x_sup[0].transpose(1,2), x_que)/16, dim=2) # K'*Q: bx10*10
